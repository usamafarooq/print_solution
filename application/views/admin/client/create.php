...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>admin/client/insert" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body"><div class="form-group row">
                                ...
                                <label for="example-text-input" class="col-sm-3 col-form-label">Client Name<span class="required">*</span></label>
                                        <div class="col-sm-9"><input class="form-control" name="Client_Name" type="text" value="" id="example-text-input" placeholder="" required=""></div>
                                ...
                                <label for="example-text-input" class="col-sm-3 col-form-label">Short Description</label>
                                        <div class="col-sm-9"><textarea class="form-control" name="Short_Description" ></textarea></div>
